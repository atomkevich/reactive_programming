...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.get__O__s_Option(name).get__O()).apply__O());
      continue _eval
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1) {
    return (function() {
      return ((140 - $m_Lcalculator_TweetLength$().count__T__I($as_T(tweetText$1.apply__O()))) | 0)
    })
  })(tweetText));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.count__T__I = (function(buf) {
  var i = 0;
  var n = $uI(buf["length"]);
  var endIndex = $uI(buf["length"]);
  while ((i < endIndex)) {
    i = ((1 + i) | 0);
    var index = (((-1) + i) | 0);
    if ((this.isHighSurrogate__C__Z((65535 & $uI(buf["charCodeAt"](index)))) && (i < endIndex))) {
      var index$1 = i;
      var jsx$1 = this.isLowSurrogate__C__Z((65535 & $uI(buf["charCodeAt"](index$1))))
    } else {
      var jsx$1 = false
    };
    if (jsx$1) {
...
$c_Lcalculator_TweetLength$.prototype.isLowSurrogate__C__Z = (function(ch) {
  return ((ch >= 56320) && (ch < 57344))
});
$c_Lcalculator_TweetLength$.prototype.isHighSurrogate__C__Z = (function(ch) {
...
$c_Lcalculator_CalculatorUI$.prototype.setupCalculator__V = (function() {
  ...
  $as_Ljava_io_PrintStream(this$17.tl$1.get__O()).println__O__V(exprs);
  $m_sci_IndexedSeq$();
  ...
  $as_Ljava_io_PrintStream(this$21.tl$1.get__O()).println__O__V(namedExpressions);
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var exp = $as_T(x0$1.$$und1$f);
    var references = $as_Lcalculator_Signal(x0$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, references$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(references$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, references));
    return new $c_T2().init___O__O(exp, new $c_Lcalculator_Signal().init___F0(expr))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
